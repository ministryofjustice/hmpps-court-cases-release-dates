  ...
  it('should render prisoner details', () => {
    ...
    return request(app)
      ...
      .expect(res => {
        ...
        expect(sixthCommonPlatformDocumentCaseRef).not.toContain('AB12345678A,BC23456789B')
  ...
  results: [
    ...
    },
    {
      ...
      metadata: {
        ...
        isUnread: 'false',
        courtCode: 'C678',
        // TODO (CDIA-325): Remove value 'AB12345678A,BC23456789B' once backend service handles concatenated case references
